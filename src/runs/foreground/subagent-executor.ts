...
const MUTATING_MANAGEMENT_ACTIONS = new Set(["create", "update", "delete"]);async function runParallelPath(data: ExecutionContextData, deps: ExecutorDeps): Promise<AgentToolResult<Details>> {
	const {
		params,
		effectiveCwd,
		agents,
