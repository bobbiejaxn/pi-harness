/**
 * Skill resolution internals — caching, path discovery, filesystem scanning.
...
export let loadSkillsCache: { cwd: string; agentDir: string; skills: CachedSkillEntry[]; timestamp: number } | null = null;
export const LOAD_SKILLS_CACHE_TTL_MS = 5000;
